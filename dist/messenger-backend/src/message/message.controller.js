...
const auth_guard_1 = require("src/auth/guards/auth.guard");
...
__decorate([
    (0, swagger_1.ApiOkResponse)({ description: 'List of all messages' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Message created successfully' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'You are not logged in.' }),
